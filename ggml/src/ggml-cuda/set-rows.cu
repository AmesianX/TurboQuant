...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    if (dst->type == GGML_TYPE_F32) {
        ...
        if (head_dim >= 512) {
            set_rows_cuda_quant_512<idx_t, block_tbq4_0, QK_K, quantize_f32_tbq4_0_block_512>(
        ...
        const int32_t head_dim = dst->op_params[0];
        if (head_dim >= 512) {
            set_rows_cuda_quant_512<idx_t, block_tbqp4_0, QK_K, quantize_f32_tbqp4_0_block_512>(
    ...
    } else if (dst->type == GGML_TYPE_TBQV3_1) {
        // tbq3 family V partner: amxv3_1 동치 (WHT + 3-bit Gaussian Lloyd-Max, MSE plain).
        set_rows_cuda_quant_sm<idx_t, block_tbqv3_1, TBQ_K128, quantize_f32_tbqv3_1_block>(
            src0_d, src1_d, (block_tbqv3_1*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
