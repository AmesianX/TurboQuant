...
\textbf{참고:} 이전 버전에서 기술한 cross-head WHT 접근법($H_{512} = H_8 \otimes H_{64}$)은 Q-K 도메인 불일치로 인해 \textbf{폐기}되었다. Q는 64차원 per-head 공간에서 동작하는 반면 K는 512차원 cross-head 공간에 있어 어떤 IWHT 복원도 이 간극을 해소할 수 없었다.
