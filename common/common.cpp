...
#include "unicode.h"
#include "tp-serve.h" // [tp-2node-dsv4] broadcast KV seq ops to the SPMD serving follower
        ...
        auto tbq_resolve = [&](ggml_type type, bool is_key) -> ggml_type {
            ...
            auto is_wrong_suffix = [&](ggml_type t) -> bool {
                bool is_1 = (t == GGML_TYPE_TBQ3_1 || t == GGML_TYPE_TBQ4_1 || t == GGML_TYPE_TBQP3_1 || t == GGML_TYPE_TBQP4_1
                            || t == GGML_TYPE_AMX3_1 || t == GGML_TYPE_AMXV3_1 || t == GGML_TYPE_TBQV3_1);
...
struct llama_context_params common_context_params_to_llama(const common_params & params) {
    ...
    if (getenv("DFLASH_RBPROBE")) {
        fprintf(stderr, "[RB cparams] n_rs_seq=%u  n_types=%zu  DFLASH_PLANE=%s\n",
                cparams.n_rs_seq, params.speculative.types.size(),
                getenv("DFLASH_PLANE") ? getenv("DFLASH_PLANE") : "(unset)");
    }
