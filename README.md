...
- 📘 [**Polar Derotation: Breaking the 3-Bit KV Cache Quality Cliff on Coupled-RoPE Language Models**](turboquant/paper/polar_derotate_paper.pdf) — theoretical foundation and evaluation of TBQX3_1 (Polar Derotation + Tangent Residual)
...
- 📕 [한국어판 — Polar Derotation](turboquant/paper/polar_derotate_paper_ko.pdf) · [한국어판 — TurboQuant 구현](turboquant/paper/turboquant_impl_ko.pdf)
